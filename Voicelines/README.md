...
4. Download dependencies: [FsmUtil](https://thunderstore.io/c/hollow-knight-silksong/p/silksong_modding/FsmUtil/)
5. Extract the downloaded archives to `silksong_path/BepInEx/plugins`
6. Launch the game
7. [Edit mod configs](https://docs.bepinex.dev/articles/user_guide/configuration.html#configuring-plugins) by using BepInEx's configuration manager (F1 by default), or by editing files in `silksong_path/BepInEx/plugins`
